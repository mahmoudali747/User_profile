...
export default  function Napoli (){
    return (
        ...
        <Image source={require('../../../assets/imges/tatics/Naboli/Neapel.png')} style={{width :65 , height : 65 , marginLeft : 100 , marginTop : -70}}/>
            <Text style={{fontSize:20 , fontWeight : "bold" , color : '#877DFA' , marginLeft : 180 , marginTop : -50 }}>Napoli  </Text>
            <View style= {{marginTop:50}}>
            <Image source={require('../../../assets/imges/tatics/Naboli/Frosinone_Calcio.png')} style={{width :71 , height : 82 , marginHorizontal : 300 , marginVertical : -10  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -85 , marginHorizontal : 106 }}> 3  -   1</Text>
            <View style={{marginTop :'auto'}}>
            <Image source={require('../../../assets/imges/tatics/Naboli/Neapel.png')} style={{width :79 , height : 79 , marginHorizontal : 15 , marginVertical : 20 }}/>
            <Image source={require('../../../assets/imges/tatics/Naboli/NBstaticas.jpg')} style={{width :420 , height : 330 , marginHorizontal : -10 , marginVertical: 10 }}/>
            <Image source={require('../../../assets/imges/tatics/Naboli/NBtatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </View>
            </View>
            </ScrollView>
    )}