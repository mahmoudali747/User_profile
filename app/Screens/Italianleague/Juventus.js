...
export default  function Juventus  (){
    ...
    return (
        ...
        <Image source={require('../../../assets/imges/tatics/JUIVI/Juventus_Logo.png')} style={{width :64 , height : 78 , marginLeft : 100 , marginTop : -70}}/>
            <Text style={{fontSize:20 , fontWeight : "bold" , color : '#877DFA' , marginLeft : 170 , marginTop : -60 }}>Juventus </Text>
            <View style= {{marginTop:50}}>
            <Image source={require('../../../assets/imges/tatics/JUIVI/Udinese_calcio.png')} style={{width :99 , height : 99 , marginHorizontal : 290 , marginVertical : -10  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -85 , marginHorizontal : 106 }}> 3  -   0</Text>
            <View style={{marginTop :'auto'}}>
            <Image source={require('../../../assets/imges/tatics/JUIVI/Juventus_Logo.png')} style={{width :74 , height : 99 , marginHorizontal : 15 , marginVertical : 10 }}/>
            <Image source={require('../../../assets/imges/tatics/JUIVI/JUVIstaticas.jpg')} style={{width :420 , height : 330 , marginHorizontal : -10 , marginVertical:0 }}/>
            <Image source={require('../../../assets/imges/tatics/JUIVI/JUIVItatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </View>
            </View>
            </ScrollView>
    )}