...
export default  function Manchestercity  (){
    ...
    return (
        ...
        <Image source={require('../../../assets/imges/tatics/ManCity/manchCitey.png')} style={{width :66 , height : 66 , marginLeft : 100 , marginTop : -70}}/>
            ...
            <Image source={require('../../../assets/imges/tatics/ManCity/manchCitey.png')} style={{width :80 , height : 80 , marginHorizontal : 300 , marginVertical : 0  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -85 , marginHorizontal : 102 }}> 0  -   1</Text>
            <View style={{marginTop :'auto'}}>
            <Image source={require('../../../assets/imges/tatics/ManCity/Newcastle_United_Logo.png')} style={{width :92 , height : 90 , marginHorizontal : 15 , marginVertical : 10 }}/>
            <Image source={require('../../../assets/imges/tatics/ManCity/MCstaics.jpg')} style={{width :420 , height : 330 , marginHorizontal : -10 , marginVertical: -10 }}/>
            <Image source={require('../../../assets/imges/tatics/ManCity/MCtatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </View>
            </View>
            </ScrollView>
    )}