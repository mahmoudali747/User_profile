...
export default  function Astonvilla (){
    return (
        ...
        <Image source={require('../../../assets/imges/tatics/AstonVilla/Astonvella.png')} style={{width :50 , height : 69 , marginLeft : 110 , marginTop : -70}}/>
            ...
            <Image source={require('../../../assets/imges/tatics/AstonVilla/Hibernian.png')} style={{width :75 , height : 82 , marginHorizontal : 300  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -85 , marginHorizontal : 110 }}>5   -   0</Text>
            <Image source={require('../../../assets/imges/tatics/AstonVilla/Astonvella.png')} style={{width :70 , height : 93 , marginHorizontal : 15 , marginVertical : 10 }}/>
            <Image source={require('../../../assets/imges/tatics/AstonVilla/ASstaics.jpg')} style={{width :424 , height : 328 , marginHorizontal : -15 , marginVertical: -10 }}/>
            <Image source={require('../../../assets/imges/tatics/AstonVilla/ASStatics.jpg')} style={{width :370 , height : 520 , marginHorizontal : 10 , marginVertical: -10 }}/>
            </ScrollView>
    )}