...
export default  function Liverpool (){
    ...
    return (
        ...
        <Image source={require('../../../assets/imges/tatics/Liver/liverpool.png')} style={{width :76 , height : 76 , marginLeft : 100 , marginTop : -70}}/>
            <Text style={{fontSize:20 , fontWeight : "bold" , color : '#877DFA' , marginLeft : 180 , marginTop : -50 }}>Liverpool</Text>
            <Image source={require('../../../assets/imges/tatics/Liver/liverpool.png')} style={{width :112 , height : 112 , marginHorizontal : 280  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -85 , marginHorizontal : 102 }}>1   -   3</Text>
            <Image source={require('../../../assets/imges/liverpoolR.png')} style={{width :65 , height : 85 , marginHorizontal : 15 , marginVertical : 10 }}/>
            <Image source={require('../../../assets/imges/tatics/Liver/staics.jpg')} style={{width :450 , height : 350 , marginHorizontal : -30 , marginVertical: -10 }}/>
            <Image source={require('../../../assets/imges/tatics/Liver/tatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </ScrollView>
    )}