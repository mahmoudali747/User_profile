...
export default  function Dortmund  (){
    ...
    return (
        ...
        <Image source={require('../../../assets/imges/tatics/Dortomld/BorussiaDortmund_.png')} style={{width :63 , height : 58 , marginLeft : 100 , marginTop : -70}}/>
            ...
            <Image source={require('../../../assets/imges/tatics/Dortomld/BorussiaDortmund_.png')} style={{width :82 , height : 77.27 , marginHorizontal : 300 , marginVertical : -20  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -60 , marginHorizontal : 106 }}> 0  -   1</Text>
            <View style={{marginTop :'auto'}}>
            <Image source={require('../../../assets/imges/tatics/Dortomld/Koeln.png')} style={{width :88.44 , height : 98 , marginHorizontal : 15 , marginVertical : -20 }}/>
            <Image source={require('../../../assets/imges/tatics/Dortomld/DORTstaticas.jpg')} style={{width :420 , height : 330 , marginHorizontal : -10 , marginVertical: 40 }}/>
            <Image source={require('../../../assets/imges/tatics/Dortomld/DORTttatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </View>
            </View>
            </ScrollView>
    )}