...
export default  function RealMadrid  (){
    return (
        ...
        <Image source={require('../../../assets/imges/tatics/REALMADRID/Real_Madrid.png')} style={{width :62 , height : 86 , marginLeft : 100 , marginTop : -70}}/>
            ...
            <Image source={require('../../../assets/imges/tatics/REALMADRID/CeltaVigo.png')} style={{width :53 , height : 103 , marginHorizontal : 300 , marginVertical : -20  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -85 , marginHorizontal : 106 }}> 1  -   0</Text>
            <View style={{marginTop :'auto'}}>
            <Image source={require('../../../assets/imges/tatics/REALMADRID/Real_Madrid.png')} style={{width :74 , height : 100 , marginHorizontal : 15 , marginVertical : 0 }}/>
            <Image source={require('../../../assets/imges/tatics/REALMADRID/REALstaticas.jpg')} style={{width :420 , height : 330 , marginHorizontal : -10 , marginVertical: 10 }}/>
            <Image source={require('../../../assets/imges/tatics/REALMADRID/REALtatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </View>
            </View>
            </ScrollView>
    )}